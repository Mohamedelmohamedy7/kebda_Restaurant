...
class AuthController extends GetxController implements GetxService {
  ...
  Future<void> getProfile({String time}) async {
    Response response = await authRepo.getProfileInfo(time:time);
    log("${response.body}*/*/*/**");
    if (response.statusCode == 200) {
  ...
  Future<void> net_by_search({String time}) async {
    print(time);
  ...
  bool isLoadingAmountByTime =false;
  // Future<bool> getAmountByTime(ProfileModel updatedUserModel, String password) async {
  //   isLoadingAmountByTime = true;
  //   update();
  //   bool _isSuccess;
  //   Response response = await authRepo.getAmountByTime(updatedUserModel, password);
  //   isLoadingAmountByTime = false;
  //   if (response.statusCode == 200) {
  //     _profileModel = ProfileModel.fromJson(response.body);
  //     _isSuccess = true;
  //   } else {
