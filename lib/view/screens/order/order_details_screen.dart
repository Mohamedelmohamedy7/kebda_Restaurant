      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
        ...
        bool _restConfModel =
            Get.find<SplashController>().configModel.orderConfirmationModel !=
                'deliveryman';
        bool _showSlider = (_controllerOrderModer.orderStatus == 'pending' &&
            ...
            (_controllerOrderModer.orderStatus == 'handover' &&
                (_selfDelivery ||
                    _controllerOrderModer.orderType == 'take_away'));
        bool _showBottomView = _showSlider ||
                          ...
                          child: Column(
                              ...
                              children: [
                                DateConverter.isBeforeTime(
                                        _controllerOrderModer.scheduleAt)
                                          ...
                                          (_order.deliveryAddress
                                              ...
                                              ? Text(
                                                  'street_number'.tr +
                                                      ...
                                                      _order.deliveryAddress
                                                          .streetNumber +
                                                      '${(_order.deliveryAddress.house != null && _order.deliveryAddress.house.isNotEmpty) ? ', ' : ' '}',
                                                  style: robotoRegular.copyWith(
                                                      fontSize: Dimensions
                                          ...
                                          (_order.deliveryAddress.house !=
                                              ...
                                              ? Text(
                                                  'house'.tr +
                                                      ...
                                                      _order.deliveryAddress
                                                          .house +
                                                      '${(_order.deliveryAddress.floor != null && _order.deliveryAddress.floor.isNotEmpty) ? ', ' : ' '}',
                                                  style: robotoRegular.copyWith(
                                                      fontSize: Dimensions
                                                          .FONT_SIZE_EXTRA_SMALL,
                                                      color: Theme.of(context)
                                ...
                                Row(
                                    ...
                                    children: [
                                      Text('phone_Number'.tr,
                                          style: robotoRegular),
                                      Spacer(),
                                      Text(widget.orderModel.clientPhone ?? "",
                                          style: robotoRegular),
                                      Spacer(),
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () {
                                            launch(
                                                "tel://${widget.orderModel.clientPhone}");
                                          },
                                        ),
                                      )
                                    ]),
                                    ...
                                    action: () {
                                      if (_controllerOrderModer.orderStatus ==
                                        ...
                                        Get.find<OrderController>()
                                          ...
                                          (_controllerOrderModer.orderStatus ==
                                                  'accepted' &&
                                              _controllerOrderModer.confirmed !=
                                                  null)) {
