...
class AuthRepo {
  ...
  Future<Response> getProfileInfo({String time}) async {
  ...
  // Future<Response> getAmountByTime(ProfileModel userInfoModel, String password) async {
  //   return await apiClient.postData(AppConstants.net_amount_by_search, {
  ...
  Future<Response> updateToken() async {
    ...
    return await apiClient.postData(AppConstants.TOKEN_URI, {"_method": "put", "token": getUserToken(),
      "fcm_token": _deviceToken,"oldToken": oldToken});
  }
